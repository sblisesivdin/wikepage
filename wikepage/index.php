...
// CODE FROM http://kallahar.com/smallprojects/php_xss_filter_function.php
// See if you can bypass the xss filter. If you can, *please* email me your attack so that I can improve the filter. kallahar@kallahar.com
